...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/media/albums/',
            'upload_url' => $this->get_full_url().'/assets/media/albums/',
			...
			*/
                'thumbnail' => array(
                    ...
                    'max_width' => 250, // either specify width, or set to 0. Then width is automatically adjusted - keeping aspect ratio to a specified max_height.
                    'max_height' => 250 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
            ),
            'print_response' => true
        );
    ...
    protected function set_additional_file_properties($file) {
    	...
    	// COMMENTED BY PANCHSOFT
        /*$file->deleteUrl = $this->options['script_url']
            .$this->get_query_separator($this->options['script_url'])
            .$this->get_singular_param_name()
            .'='.rawurlencode($file->name);*/
        $file->deleteUrl = base_url().'administrator/fileupload?'.$this->get_singular_param_name().'='.rawurlencode($file->name);
