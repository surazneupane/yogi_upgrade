...
class Facebook
{
	...
	public function fb_callback()
	{
	    ...
	    try {
	        ...
	        $response = $this->fb->get('/me?fields=id,name,email,first_name,last_name,link', $accessToken);
...
// 	    $hometown         = $user->getHometown();
	...
	private function addNewUser(\Facebook\GraphNodes\GraphUser $user)
	{
	    ...
	    $additional_data = [
	        ...
	        'photo'        => 'avatars/'.$user->getId() . '.jpg',
	    ];
	    
	    return $this->ci->facebook_model->register($user->getId(), random_string(), $email, $additional_data);
	}
