...
<div class="content-wrapper">
	...
	<div class="subcategories-layout-wrapper mostreadarticlespage-layout-wrapper" itemscope itemtype="https://schema.org/Blog">
		<div class="container">

			<div class="category-content-wrapper mostreadarticles-content-wrapper">
				<div class="title-block">
					<h3 class="title" itemprop="name">أكثر المقالات قراء</h3>
					<div class="sepertator"></div>
				</div>
				<div class="category-content-block">
				
					<?php if(!empty($mostread_articles)) { ?>
					<div id="mostreadarticles-content-row" class="row">
					...
					<?php if(count($mostread_articles) >= 6) { ?>
						<div id="form-loadmore-div" class="form-loadmore-div">
							<!-- form start -->
							<?php echo form_open('',array('id'=>'mostreadarticles-list-form', 'class'=>'mostreadarticles-list-form')); ?>
...
<script src="<?php echo base_url(); ?>assets/site/js/mostreadarticles_view.js"></script>