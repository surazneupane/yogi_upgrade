...
<div class="content-wrapper">
	...
	<div class="subcategories-layout-wrapper favoritearticlespage-layout-wrapper" itemscope itemtype="https://schema.org/Blog">
		<div class="container">

			<div class="category-content-wrapper favoritearticles-content-wrapper">
				<div class="title-block">
					<h3 class="title" itemprop="name">مقالاتي المفضلة</h3>
					<div class="sepertator"></div>
				</div>
				<div class="category-content-block">
				
					<?php if(!empty($favorite_articles)) { ?>
					<div id="favoritearticles-content-row" class="row">
						<?php foreach ($favorite_articles AS $favorite_article) { ?>
						<?php 
						...
						<div class="col-md-4 content-block-col" data-mh="heightConsistancy">
							<div class="content-block">
								...
								<div class="img-div">
									<a href="<?php echo $article_link; ?>" title="<?php echo $favorite_article['title']; ?>">
										<?php 
										...
										?>
										<img title="<?php echo $favorite_article['title']; ?>" alt="<?php echo $favorite_article['title']; ?>" src="<?php echo base_url(); ?>assets/site/images/yawmiyati-default.jpg" data-src="<?php echo base_url().$favorite_article['image']; ?>" class="lazyload img-responsive center-block"/>
									</a>
								</div>
								<div class="content-div">
									<h4><a href="<?php echo $article_link; ?>" title="<?php echo $favorite_article['title']; ?>"><?php echo $favorite_article['title']; ?></a></h4>
									<?php if($favorite_article['description'] != '' || $favorite_article['article_layout'] != 'media') { ?>
										<?php 
					...
					<?php // if(count($favorite_articles) >= 6) { ?>
						<div id="form-loadmore-div" class="form-loadmore-div">
							<!-- form start -->
							<?php echo form_open('',array('id'=>'favoritearticles-list-form', 'class'=>'favoritearticles-list-form')); ?>
...
<script src="<?php echo base_url(); ?>assets/site/js/favoritearticles_view.js"></script>