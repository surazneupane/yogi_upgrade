...
<script type="text/javascript">
	...
	jQuery(document).ready( function() {
		...
		var galleryThumbHeight = jQuery('.fashion-layout-wrapper .article-fashion-layout-wrapper-gallery-wrapper .gallery-thumbs').height();
		jQuery('.article-fashion-layout-wrapper-gallery-wrapper #swiper-container-horizontal .swiper-slide').css('height', galleryThumbHeight-15+'px');
		...
		var galleryTop = new Swiper('#swiper-container-horizontal', {
			speed: 800,
			loop:true,			
			navigation: {
		...
		jQuery('.gallery-thumbs .swiper-slideto').click( function() {
		
			var slideto = jQuery(this).attr('slideto');
			galleryTop.slideTo(slideto, 800);
...
<div class="fashion-layout-wrapper">

	<div class="article-fashion-layout-wrapper">
		...
		<div class="article-fashion-layout-wrapper-gallery-wrapper">
			<!-- Swiper -->
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div id="swiper-container-horizontal" class="swiper-container swiper-container-horizontal">
						<div class="swiper-wrapper">
							<?php $i = 1; foreach ($media_images AS $media_image) { ?>
								<?php if($media_image != '') { ?>
									<div class="swiper-slide">
										...
										<?php if($media_texts[$i-1] != '') { ?>
										<div class="swipter-text">
											<?php echo $media_texts[$i-1]; ?>
										</div>
										<?php } ?>
									</div>
								<?php $i++; } ?>
							...
							<?php $i = 1; foreach ($media_images AS $media_image) { ?>
								<?php if($media_image != '') { ?>
									<div class="col-md-6 col-sm-6 col-xs-6">
										<div class="swiper-slide">
											<a href="javascript:void(0)" class="swiper-slideto" slideto="<?php echo $i; ?>">
												<img src="<?php echo site_url('assets/media/'.$media_image); ?>" class="img-responsive" title="<?php echo $article['title']; ?>" alt="<?php echo $article['title']; ?>" />
											</a>
										</div>
									</div>
	...
	<div class="articlepage-content-characteristic-wrapper">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12 articlepage-content-characteristic-right-col">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 articlepage-content-characteristic-left-col">
