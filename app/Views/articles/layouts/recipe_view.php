...
<div class="recipe_view-layout-wrapper">
	...
	<div class="article-recipe-content-div">
		<div class="row">
			<div class="col-md-4 col-sm-4 article-recipe-content-right-col" data-mh="heightConsistancy">
				<div class="recipe-detail recipe-cooking-time">
					<img src="<?php echo site_url('assets/site/images/icon-clock.png'); ?>" title="<?php echo $article['recipe_time']; ?>" alt="<?php echo $article['recipe_time']; ?>" /> <?php echo $article['recipe_time']; ?> دقيقة
				</div>
				<div class="recipe-detail recipe-serves">
					<img src="<?php echo site_url('assets/site/images/icon-serve-dish.png'); ?>" title="<?php echo $article['recipe_persons']; ?>" alt="<?php echo $article['recipe_persons']; ?>" /> <?php echo $article['recipe_persons']; ?> أشخاص
				</div>
				<div class="recipe-detail recipe-ingredients">
					<img src="<?php echo site_url('assets/site/images/icon-ingredients.png'); ?>" title="المقادير" alt="المقادير" /> المقادير
				</div>
				<div class="recipe-ingredients-list">
					<?php $ingredients = json_decode($article['recipe_ingredients']); ?>
			...
			<div class="col-md-8 col-sm-8 article-recipe-content-left-col" data-mh="heightConsistancy">
	...
	<?php if($article['mangomolo_videoid'] != '') { ?>
	<div class="article-video-div">
		<?php $mangoVideoDetails = $this->mangomolo->GetMangomoloVideoDetailsByID($article['mangomolo_videoid']); ?>
		<div class="embed-responsive embed-responsive-16by9">
			<iframe class="embed-responsive-item" src="<?php echo $mangoVideoDetails->embed; ?>"></iframe>
		</div>
	</div>
	<?php } ?>
