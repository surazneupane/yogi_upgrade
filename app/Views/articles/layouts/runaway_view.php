...
<script type="text/javascript">
	...
	jQuery(document).ready( function() {
		...
		var owl = jQuery('#runaway_carousel<?php echo $article['id']; ?>').owlCarousel({
			rtl : true,
			loop : true,
			margin : 0,
			autoplay : true,
...
<div class="travel_view-layout-wrapper runaway_view-layout-wrapper">
	...
	<div class="article-travel-information-div">
		...
		<div id="runaway_carousel<?php echo $article['id']; ?>" class="runaway_carousel owl-carousel custom-nav-carousel">
