...
<script type="text/javascript">
	...
	jQuery(document).ready( function() {
		...
		jQuery('#text_mulitplemedia_carousel<?php echo $article['id']; ?>').owlCarousel({
			rtl : true,
			loop : true,
			margin : 0,
			autoplay : false,
...
<div class="text_mulitplemedia_view-layout-wrapper">

	
	<?php if(!empty($media_images) && $media_images[0] != '') { ?>
	<div class="article-text_mulitplemedia-media-div">
		<div id="text_mulitplemedia_carousel<?php echo $article['id']; ?>" class="text_mulitplemedia_carousel owl-carousel">
