	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<!-- form start -->
				<?php echo form_open('', array('id' => 'tag-edit-form', 'class' => 'tag-edit-form')); ?>
				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('title', $tag['title'], 'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('alias', $tag['alias'], 'class="form-control"'); ?>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<div class="form-group">
									...
									<?php echo form_textarea('description', $tag['description'], 'class="textarea"'); ?>
								</div>
							</div>
						</div>
						<div class="col-md-6">
								...
								<div class="row">
									<div class="col-lg-7">
										<div class="input-group">
											...
											<?php
											if ($tag['image'] != '') {
												$tag_image = "<img src='" . site_url('assets/media/') . $tag['image'] . "' class='img-responsive' />";
											} else {
												$tag_image = 'No image selected.';
											}
											?>

											<span class="input-group-btn">
												<a href="javascript:void(0)" data-toggle="popover" data-html="true" data-placement="top" data-trigger="hover" title="Selected Image" data-content="<?php echo $tag_image; ?>" data-content="<div class='popover' role='tooltip'><div class='arrow'></div><h3 class='popover-title'>Selected Image</h3><div class='popover-content'><?php echo $tag_image; ?></div></div>" class="btn btn-default"><i class="fa fa-eye"></i></a>
											</span>

											<?php echo form_input('image', $tag['image'], 'id="fieldImgID" class="form-control"'); ?>
											<span class="input-group-btn">
							...
							<div class="form-group">
								...
								$options[1] = 'Publish';
								$options[0] = 'Unpublish';
								echo form_dropdown('status', $options, $tag['status'], 'class="form-control"');
								?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo form_input('created_date', $tag['created_date'], 'class="form-control readonly" readonly="readonly"'); ?>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								echo form_dropdown('created_by', $options, $tag['created_by'], 'class="form-control"');
								?>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<?php echo form_input('meta_title', $tag['meta_title'], 'id="meta_title" class="form-control" placeholder="Meta Title"'); ?>
					</div>
					<div class="form-group">
						...
						<?php echo form_textarea('meta_description', $tag['meta_description'], 'id="meta_description" class="form-control" placeholder="Meta Description"'); ?>
					</div>

				</div>
				<!-- /.box-body -->

				<?php echo form_hidden('tag_id', set_value('tag_id', $tag['id'])); ?>
