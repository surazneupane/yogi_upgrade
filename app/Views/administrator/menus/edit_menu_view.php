...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		jQuery('.btn-toolbar .btn-submit').click(function() {
			...
			jQuery('#menu-edit-form').submit();

		});

		var menu_type = jQuery('#menu_type').val();
		changeMenuTypeDivs(menu_type);
		...
		function changeMenuTypeDivs(menu_type) {
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<!-- form start -->
				<?php echo form_open('', array('id' => 'menu-edit-form', 'class' => 'menu-edit-form')); ?>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('title', $menu['title'], 'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('title_fr', $menu['title_fr'], 'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('alias', $menu['alias'], 'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								echo form_dropdown('parent_id', $options, $menu['parent_id'], 'class="form-control select2"');
								?>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								echo form_dropdown('menu_type', $options, $menu['menu_type'], 'id="menu_type" class="form-control" ');
								?>
							</div>
						</div>
						<div class="category_menu_type_col col-md-4" id="category_menu_type_col" style="display: none;">
							<div class="form-group">
								...
								echo form_dropdown('menu_category_alias', $options, $menu['menu_category_alias'], 'class="form-control select2"');
								?>
							</div>
						</div>
						<div class="video_category_menu_type_col col-md-4" id="video_category_menu_type_col" style="display: none;">
							<div class="form-group">
								...
								echo form_dropdown('menu_video_category_id', $options, $menu['menu_video_category_id'], 'class="form-control select2"');
								?>
							</div>
						</div>
						<div class="article_menu_type_col col-md-8" id="article_menu_type_col" style="display: none;">
							<div class="form-group">
								...
								echo form_dropdown('menu_article_alias', $options, $menu['menu_article_alias'], 'class="form-control select2"');
								?>
							</div>
						</div>
						<div class="tag_menu_type_col col-md-4" id="tag_menu_type_col" style="display: none;">
							<div class="form-group">
								...
								echo form_dropdown('menu_tag_alias', $options, $menu['menu_tag_alias'], 'class="form-control select2"');
								?>
							</div>
						</div>
						<div class="col-md-8" id="customlink_menu_type_col" style="display: none;">
							<div class="form-group">
								...
								<?php echo form_input('menu_custom_link', $menu['menu_custom_link'], 'class="form-control"'); ?>
							</div>
							<div class="form-group">
								...
								<?php echo form_input('menu_custom_link_fr', $menu['menu_custom_link_fr'], 'class="form-control"'); ?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('menu_class',  $menu['menu_class'], 'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								echo form_dropdown('menu_target', $options, $menu['menu_target'], 'id="menu_target" class="form-control" ');
								?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								$options[1] = 'Publish';
								$options[0] = 'Unpublish';
								echo form_dropdown('status', $options, $menu['status'], 'class="form-control"');
								?>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo form_input('created_date', $menu['created_date'], 'class="form-control readonly" readonly="readonly"'); ?>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								echo form_dropdown('created_by', $options, $menu['created_by'], 'class="form-control"');
								?>
							</div>
						</div>
					</div>
				...
				<?php echo form_hidden('menu_id', set_value('menu_id', $menu['id'])); ?>
