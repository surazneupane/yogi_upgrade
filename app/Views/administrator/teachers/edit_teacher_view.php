...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		jQuery('.btn-toolbar .btn-submit').click(function() {
			...
			jQuery('#teacher-edit-form').submit();
...
<section class="content-header">
	<h1>
		Edit Teacher
		<small>Edit yoga teacher</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url('administrator/dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li><a href="<?php echo site_url('administrator/teachers'); ?>">Teachers</a></li>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<!-- form start -->
				<?php echo form_open('', array('id' => 'teacher-edit-form', 'class' => 'teacher-edit-form')); ?>
				...
				<div class="box-header with-border">
					<div class="btn-toolbar">
						...
						<a href="<?php echo site_url('administrator/teachers'); ?>" class="btn btn-default"><i class="fa fa-times-circle"></i> Cancel</a>
					</div>
				</div>
				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('title', $teacher['title'], 'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('alias', $teacher['alias'], 'class="form-control"'); ?>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<div class="form-group">
									...
									<?php echo form_textarea('description', $teacher['description'], 'class="textarea"'); ?>
								</div>
							</div>
						</div>
						<div class="col-md-6">
								...
								<div class="row">
									<div class="col-lg-7">
										<div class="input-group">
											...
											<?php
											if ($teacher['image'] != '') {
												$teacher_image = "<img src='" . site_url('assets/media/') . $teacher['image'] . "' class='img-responsive' />";
											} else {
												$teacher_image = 'No image selected.';
											}
											?>

											<span class="input-group-btn">
												<a href="javascript:void(0)" data-toggle="popover" data-html="true" data-placement="top" data-trigger="hover" title="Selected Image" data-content="<?php echo $teacher_image; ?>" data-content="<div class='popover' role='tooltip'><div class='arrow'></div><h3 class='popover-title'>Selected Image</h3><div class='popover-content'><?php echo $teacher_image; ?></div></div>" class="btn btn-default"><i class="fa fa-eye"></i></a>
											</span>

											<?php echo form_input('image', $teacher['image'], 'id="fieldImgID" class="form-control"'); ?>
											<span class="input-group-btn">
							...
							<div class="form-group">
								...
								$options[1] = 'Publish';
								$options[0] = 'Unpublish';
								echo form_dropdown('status', $options, $teacher['status'], 'class="form-control"');
								?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo form_input('created_date', $teacher['created_date'], 'class="form-control readonly" readonly="readonly"'); ?>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								echo form_dropdown('created_by', $options, $teacher['created_by'], 'class="form-control"');
								?>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<?php echo form_input('meta_title', $teacher['meta_title'], 'id="meta_title" class="form-control" placeholder="Meta Title"'); ?>
					</div>
					<div class="form-group">
						...
						<?php echo form_textarea('meta_description', $teacher['meta_description'], 'id="meta_description" class="form-control" placeholder="Meta Description"'); ?>
					</div>

				</div>
				<!-- /.box-body -->

				<?php echo form_hidden('teacher_id', set_value('teacher_id', $teacher['id'])); ?>
