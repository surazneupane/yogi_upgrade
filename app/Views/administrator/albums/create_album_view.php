...
<script type="text/javascript">
	...
	jQuery(document).ready( function() {
		...
		jQuery('.btn-toolbar .btn-submit').click( function() {
			...
			jQuery('#album-create-form').submit();
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<!-- form start -->
				<?php echo form_open_multipart('',array('id'=>'album-create-form', 'class'=>'album-create-form')); ?>
...
<script type="text/javascript">
	...
	jQuery(document).ready( function() {
	    ...
	    jQuery('#album-create-form').fileupload({
