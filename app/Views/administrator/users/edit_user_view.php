								...
								<div class="row">
									<div class="col-lg-7">
										<div class="input-group">
											...
											<?php
											$upload_photo =  site_url('assets/media/') . $photo;
											?>
