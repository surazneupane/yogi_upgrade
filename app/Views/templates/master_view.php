...
echo view('templates/_parts/master_header_view');
...
<div class="pscms-wrapper site-wrapper">
	...
	<?php echo view('templates/_parts/master_menu_view'); ?>
	...
	<div class="<?php if (service('router')->controllerName() == 'register' || service('router')->controllerName() == 'forgotpassword') { ?> register-wrapper <?php } else { ?> page-content-wrapper <?php } ?>">
	...
	<?php echo view('templates/_parts/master_footer_view'); ?>
